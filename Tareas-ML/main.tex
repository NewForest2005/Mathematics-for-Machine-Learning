...
\end{figure} \\
\textbf{Solucion:} La figura ilustra la construcción de una función continua y lineal por partes mediante la agregación de tres unidades ocultas con activación ReLU:
\[
