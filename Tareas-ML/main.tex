...
¿Por qué $H(\mathcal X) = - \Sigma_{x \in \mathcal X} p(x) log \ p(x)$? \\ \\
\textbf{Solución:} \\ \\
...
\textbf{Solución:} Redirigirse al siguiente \hyperlink{https://colab.research.google.com/drive/1VsHPskZ8GEHAOjnnoC54lV5ICCNrOiIC?usp=sharing}{cuaderno} para la solución.
...
\noindent A partir de la desigualdad de Hoeffding, determine, entre los parámetros $\epsilon$ y $\delta = 2Me^(-2N\epsilon^2)$, cuál controla de una mejor manera el $N$, con $N$ número de datos. \\ \\
\textbf{Solución:}
